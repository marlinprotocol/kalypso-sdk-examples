...
let imageId =
  "0xbe8b537475a76008f0d8fc4257a6e79f98571aeaa12651598394ea18a0a3bfd6";
...
let proofBytes = new AbiCoder().encode(type_input, [
  seal,
  imageId,
  journal_bytes,
]);
...
const createAskTest = async () => {
  ...
  const proofTx = await kalypso.MarketPlace().submitProof(askId, proofBytes);
