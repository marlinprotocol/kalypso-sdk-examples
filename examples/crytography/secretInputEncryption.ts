...
} from "kalypso-sdk/dist/helper/secretInputOperation";
...
async function main(): Promise<string> {
  const sk = new PrivateKey(
    Buffer.from(
      "ca9cbf143a43e422a307b03ec61a82ce99c053290c3053655d0ad69e863a18c4",
      "hex",
    ),
  );
  ...
  // Decrypt data
  const decryptedData = await decryptDataWithECIESandAES(
